        ...
        <div className='homeContainer__contact'>
          ...
          <div className='homeContainer__contact__info'>
            ...
            <div className='homeContainer__contact__info__socialmedia'>
              ...
              <a herf='https://www.instagram.com/sonnet_little_lamb/?hl=en' target="_blank" rel="noreferrer" ><img width={'26px'} height={'26px'} src='https://static.wixstatic.com/media/81af6121f84c41a5b4391d7d37fce12a.png/v1/fill/w_52,h_52,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/Instagram.png'/></a>
            </div>
          </div>
        </div>
      <Footer/>
