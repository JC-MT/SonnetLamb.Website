  ...
  return (
    <div className='productionsContainer'>
        ...
        <div className="productionsContainer__production">
            ...
            <p className="productionsContainer__production__details" >Theatre Tulsa's A Little Night Music promo photo. Sonnet starred as Anne Egerman in early Spring 2020.</p>
        </div>
    </div>
  )
}