  ...
  return (
    <div className='footerContainer'>
        <div className='footerContainer__socialmedia'>
            ...
            <a href='https://www.instagram.com/sonnetlamb' target="_blank" rel="noreferrer" ><img width={'20px'} height={'20px'} src='https://static.wixstatic.com/media/01c3aff52f2a4dffa526d7a9843d46ea.png/v1/fill/w_40,h_40,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/Instagram.png'/></a>
        </div>
